...
HD_PWD='C:/Users/poyisamu/fifoStream/fifoStream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log canteloupe_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source canteloupe_wrapper.tcl -notrace

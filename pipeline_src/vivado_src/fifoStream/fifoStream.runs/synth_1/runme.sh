...
HD_PWD='C:/Users/poyisamu/fifoStream/fifoStream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log canteloupe_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source canteloupe_wrapper.tcl

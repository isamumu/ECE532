...
HD_PWD='C:/Users/poyisamu/fifoStream/fifoStream.runs/canteloupe_tri_mode_ethernet_ma_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log canteloupe_tri_mode_ethernet_ma_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source canteloupe_tri_mode_ethernet_ma_1_0.tcl

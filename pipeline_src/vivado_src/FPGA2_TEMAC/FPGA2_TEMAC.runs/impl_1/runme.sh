...
HD_PWD='C:/Users/poyisamu/FPGA2_TEMAC/FPGA2_TEMAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_mode_ethernet_mac_2_example_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tri_mode_ethernet_mac_2_example_design.tcl -notrace

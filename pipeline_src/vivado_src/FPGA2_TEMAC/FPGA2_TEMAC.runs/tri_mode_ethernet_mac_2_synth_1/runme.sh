...
HD_PWD='C:/Users/zhouyuf5/FPGA2_TEMAC/FPGA2_TEMAC.runs/tri_mode_ethernet_mac_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_mode_ethernet_mac_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tri_mode_ethernet_mac_2.tcl

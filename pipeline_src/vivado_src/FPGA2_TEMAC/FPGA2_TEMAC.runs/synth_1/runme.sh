...
HD_PWD='C:/Users/poyisamu/FPGA2_TEMAC/FPGA2_TEMAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_mode_ethernet_mac_2_example_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tri_mode_ethernet_mac_2_example_design.tcl

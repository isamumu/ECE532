...
#
# Generated by export_simulation on Tue Mar 02 14:46:26 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './tri_mode_ethernet_mac_2.sh' script.

./tri_mode_ethernet_mac_2.sh -reset_run
...
./tri_mode_ethernet_mac_2.sh -noclean_files

For more information on the script, please type './tri_mode_ethernet_mac_2.sh -help'.

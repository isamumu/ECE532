...
#
# Generated by Vivado on Tue Mar 09 14:07:26 -0500 2021
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2018.3.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../tri_mode_ethernet_mac_2_ex.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../tri_mode_ethernet_mac_2_ex.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log

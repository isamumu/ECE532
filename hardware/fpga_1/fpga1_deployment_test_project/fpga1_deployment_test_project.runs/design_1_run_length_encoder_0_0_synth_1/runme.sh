...
HD_PWD='/home/justin/jhai/universityoftoronto/ECE532/final_project/ECE532/hardware/fpga_1/fpga1_deployment_test_project/fpga1_deployment_test_project.runs/design_1_run_length_encoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_run_length_encoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_run_length_encoder_0_0.tcl
